 ...
 * @package    core
 * @subpackage lib
 * @copyright  1999 onwards Marcelo Valvassori Bittencourt https://github.com/bitts
...
function getUsersData() {
	...
	try {
		...
		$itens = array('userid','username','name','useremail', 'om','posto','doc','tempo','funcao','contato1','contato2','email','educacao','cidade');
		if($export && $alunos){
...
function listage($itens, $turma_id, $turma){
	...
	$retorno .= "<p><a href='?op=exporta&id={$turma_id}&export=1'><button class='btn btn-secondary'>Exportar para CSV</button></a></p>
